...
public class DictionaryReference {
    ...
    public static final Logger logger = LoggerFactory.getLogger(DictionaryReference.class.getName());
    ...
    private static void readDictionaryFile() throws JsonProcessingException {
        ...
        String message = new StringBuilder().append("Dictionary creted with ")
